# FEDGE train and test without STG. Please use FEDGE_FS to select features. 
# %%
import os
import argparse
import logging
...
def get_parameters():
    ...
    parser.add_argument("--output", type=str,
                        default='output/FEDGE_output.csv', help="output file")
...
model_save_path = "model/FEDGE"
if not os.path.exists(model_save_path):
    os.makedirs(model_save_path)
device = "cuda" if torch.cuda.is_available() else "cpu"
writer = SummaryWriter("runs/fedge_{}".format(target_app))
